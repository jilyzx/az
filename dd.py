...
get_default_cli().invoke(['group', 'create', '--name', 'az','--location', 'eastus2'])
...
for location in locations:
    ...
    for a in range(0, size1_count):
        ...
        get_default_cli().invoke(
            ['vm', 'create', '--resource-group', 'az', '--name',
             f'{location}-{size1_abbreviation}-{count}', '--image', 'Canonical:UbuntuServer:18.04-LTS:18.04.202105120',
